...
public class Main {
    public static void main(String[] args) {
        String filePath = "src/main/java/streams/data_streams_store_and_retrieve_primitive_data/student_data.txt";  // Binary file to store student data

        // Creating a sample student object
        Student student = new Student(101, "Durgesh", 4.5);
