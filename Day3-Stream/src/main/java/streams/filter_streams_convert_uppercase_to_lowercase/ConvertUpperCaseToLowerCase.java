package streams.filter_streams_convert_uppercase_to_lowercase;
...
public class ConvertUpperCaseToLowerCase {
    ...
    public static void readConvertAndWrite(String sourceFileName, String destinationFileName){
        ...
        String myFile = "src/main/java/streams/filter_streams_convert_uppercase_to_lowercase/" + sourceFileName;
        String myFile2 = "src/main/java/streams/filter_streams_convert_uppercase_to_lowercase/" + destinationFileName;
