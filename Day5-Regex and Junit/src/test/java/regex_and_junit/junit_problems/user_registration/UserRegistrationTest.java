package regex_and_junit.junit_problems.user_registration;
...
public class UserRegistrationTest {
    ...
    void testInvalidEmail() {
        assertThrows(IllegalArgumentException.class, () -> UserRegistration.registerUser("Durgesh", "invalid-email", "Pass1234"));
